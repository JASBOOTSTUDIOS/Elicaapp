# ISSUE-037: Health Check del API
...
**Historia de Usuario Completa**: [US-037](../historias-usuario/US-037-health-check.md)

---

## Criterios de Aceptacion

Ver la [historia de usuario completa](../historias-usuario/US-037-health-check.md) para los criterios de aceptacion detallados.

---

## Checklist de Tareas

Ver la [historia de usuario completa](../historias-usuario/US-037-health-check.md) para las tareas tecnicas detalladas paso a paso.
...
- **Historia de Usuario**: [US-037](../historias-usuario/US-037-health-check.md)
