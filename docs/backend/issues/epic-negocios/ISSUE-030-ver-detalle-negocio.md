# ISSUE-030: Ver Detalle de un Negocio
...
**Historia de Usuario Completa**: [US-030](../historias-usuario/US-030-ver-detalle-negocio.md)

---

## Criterios de Aceptacion

Ver la [historia de usuario completa](../historias-usuario/US-030-ver-detalle-negocio.md) para los criterios de aceptacion detallados.

---

## Checklist de Tareas

Ver la [historia de usuario completa](../historias-usuario/US-030-ver-detalle-negocio.md) para las tareas tecnicas detalladas paso a paso.
...
- **Historia de Usuario**: [US-030](../historias-usuario/US-030-ver-detalle-negocio.md)
