# ISSUE-031: Ver Detalle de un Servicio
...
**Historia de Usuario Completa**: [US-031](../historias-usuario/US-031-ver-detalle-servicio.md)

---

## Criterios de Aceptacion

Ver la [historia de usuario completa](../historias-usuario/US-031-ver-detalle-servicio.md) para los criterios de aceptacion detallados.

---

## Checklist de Tareas

Ver la [historia de usuario completa](../historias-usuario/US-031-ver-detalle-servicio.md) para las tareas tecnicas detalladas paso a paso.
...
- **Historia de Usuario**: [US-031](../historias-usuario/US-031-ver-detalle-servicio.md)
